function(add_module_target tgt_name tgt_dir tgt_deps tgt_test_deps)
  ...
  if(tgt_src)
    ...
    target_include_directories(${tgt_name_lib} PUBLIC
      $<BUILD_INTERFACE:${tgt_dir}/include>
      $<INSTALL_INTERFACE:include>
    )
    target_link_libraries(${tgt_name_lib} PUBLIC ${tgt_deps})
  else()
    add_library(${tgt_name_lib} INTERFACE ${tgt_src} ${tgt_hdr})
    target_include_directories(${tgt_name_lib} INTERFACE
      $<BUILD_INTERFACE:${tgt_dir}/include>
      $<INSTALL_INTERFACE:include>
    )
  ...
  install(DIRECTORY ${tgt_dir}/include/
    DESTINATION include
  )
